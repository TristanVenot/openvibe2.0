...
if NOT !STRIPPEDARG! == !EMPTY! (
	...
	IF /i "!STRIPPEDARG!" == "--run-bg" (
		...
		SET OV_RUN_IN_BG=START "openvibe-external-stimulation-connection-example.exe"
		SET OV_PAUSE=
		goto found:
	)
...
%OV_RUN_IN_BG% "%OV_PATH_ROOT%\bin\openvibe-external-stimulation-connection-example.exe"  %ARGS%
