	...
	namespace OpenViBEAcquisitionServerPlugins
	{
		class CPluginLSLOutput : public IAcquisitionServerPlugin
		{
			...
			public:
				...
				virtual bool startHook(const std::vector<OpenViBE::CString>& vSelectedChannelNames, uint32_t ui32SamplingFrequency, uint32_t ui32ChannelCount, uint32_t ui32SampleCountPerSentBlock);
