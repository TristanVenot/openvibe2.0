...
bool CBoxAlgorithmClassifierAccuracyMeasure::initialize(void)
{
	...
	//widgets
	m_pMainWidgetInterface=gtk_builder_new(); // glade_xml_new(OpenViBE::Directories::getDataDir() + "/plugins/simple-visualization/openvibe-simple-visualization-ClassifierAccuracyMeasure.ui", "classifier-accuracy-measure-table", NULL);
	gtk_builder_add_from_file(m_pMainWidgetInterface, OpenViBE::Directories::getDataDir() + "/plugins/evaluation/openvibe-simple-visualization-ClassifierAccuracyMeasure.ui", NULL);

	m_pToolbarWidgetInterface=gtk_builder_new(); // glade_xml_new(OpenViBE::Directories::getDataDir() + "/plugins/simple-visualization/openvibe-simple-visualization-ClassifierAccuracyMeasure.ui", "classifier-accuracy-measure-toolbar", NULL);
	gtk_builder_add_from_file(m_pToolbarWidgetInterface, OpenViBE::Directories::getDataDir() + "/plugins/evaluation/openvibe-simple-visualization-ClassifierAccuracyMeasure.ui", NULL);
...
bool CBoxAlgorithmClassifierAccuracyMeasure::process(void)
{
	...
	for(uint32 i=0; i<l_rDynamicBoxContext.getInputChunkCount(0); i++)
	{
		...
		if(m_oTargetStimulationDecoder.isHeaderReceived())
		{
			...
			for(uint32 i=0; i<l_rStaticBoxContext.getInputCount()-1; i++)
			{
				::GtkBuilder* l_pGtkBuilderBar=gtk_builder_new(); // glade_xml_new(OpenViBE::Directories::getDataDir() + "/plugins/simple-visualization/openvibe-simple-visualization-ClassifierAccuracyMeasure.ui", "progress-bar-classifier-accuracy", NULL);
				gtk_builder_add_from_file(l_pGtkBuilderBar, OpenViBE::Directories::getDataDir() + "/plugins/evaluation/openvibe-simple-visualization-ClassifierAccuracyMeasure.ui", NULL);

				::GtkBuilder* l_pGtkBuilderLabel=gtk_builder_new(); // glade_xml_new(OpenViBE::Directories::getDataDir() + "/plugins/simple-visualization/openvibe-simple-visualization-ClassifierAccuracyMeasure.ui", "label-classifier-name", NULL);
				gtk_builder_add_from_file(l_pGtkBuilderLabel, OpenViBE::Directories::getDataDir() + "/plugins/evaluation/openvibe-simple-visualization-ClassifierAccuracyMeasure.ui", NULL);
