...
namespace OpenViBEPlugins
{
	namespace Matlab
	{
		...
		public:
			...
			bool setManagers(OpenViBE::Kernel::ILogManager* logManager, OpenViBE::Kernel::IErrorManager* errorManager) { m_pLogManager = logManager; m_pErrorManager = errorManager; return true; };
		...
		private:
			...
			OpenViBE::Kernel::ILogManager* m_pLogManager = nullptr;
			OpenViBE::Kernel::IErrorManager* m_pErrorManager = nullptr;
