...
[Sun Dec 16 16:21:40 2018]
-------------------------

The generator produced the following files:

The Box class:
- ovpCBoxAlgorithmJeuPong.h
- ovpCBoxAlgorithmJeuPong.cpp
...
You may have to change the file ovpCBoxAlgorithmJeuPong.h to make it find the included file ovp_defines.h, whose path is related to the project used.
...
#include "[my-box-folder]/ovpCBoxAlgorithmJeuPong.h"
...
OVP_Declare_New(OpenViBEPlugins::Visualisation::CBoxAlgorithmJeuPongDesc);
...
