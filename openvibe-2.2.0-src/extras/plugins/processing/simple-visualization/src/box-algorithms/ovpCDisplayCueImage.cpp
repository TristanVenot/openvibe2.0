...
namespace OpenViBEPlugins
{
	namespace SimpleVisualization
	{
		...
		bool CDisplayCueImage::initialize()
		{
			...
			const CString l_sUIFile = OpenViBE::Directories::getDataDir() + "/plugins/simple-visualization/openvibe-simple-visualization-DisplayCueImage.ui";
