...
namespace OpenViBEPlugins
{
	namespace SimpleVisualization
	{
		...
		private:
			...
			typedef void (CBoxAlgorithmP300SpellerVisualization::*_cache_callback_)(CBoxAlgorithmP300SpellerVisualization::SWidgetStyle& rWidgetStyle, void* pUserData);
			...
			void _cache_change_null_cb_(CBoxAlgorithmP300SpellerVisualization::SWidgetStyle& rWidgetStyle, void* pUserData);
			void _cache_change_background_cb_(CBoxAlgorithmP300SpellerVisualization::SWidgetStyle& rWidgetStyle, void* pUserData);
			void _cache_change_foreground_cb_(CBoxAlgorithmP300SpellerVisualization::SWidgetStyle& rWidgetStyle, void* pUserData);
			void _cache_change_font_cb_(CBoxAlgorithmP300SpellerVisualization::SWidgetStyle& rWidgetStyle, void* pUserData);
			void _cache_collect_widget_cb_(CBoxAlgorithmP300SpellerVisualization::SWidgetStyle& rWidgetStyle, void* pUserData);
			void _cache_collect_child_widget_cb_(CBoxAlgorithmP300SpellerVisualization::SWidgetStyle& rWidgetStyle, void* pUserData);
		...
		private:
			...
			std::map < unsigned long, std::map < unsigned long, CBoxAlgorithmP300SpellerVisualization::SWidgetStyle > > m_vCache;
		...
		public:
			...
			virtual OpenViBE::CString getName(void) const                { return OpenViBE::CString("P300 Speller Visualization"); }
			...
			virtual OpenViBE::CIdentifier getCreatedClass(void) const    { return OVP_ClassId_BoxAlgorithm_P300SpellerVisualization; }
			virtual OpenViBE::Plugins::IPluginObject* create(void)       { return new OpenViBEPlugins::SimpleVisualization::CBoxAlgorithmP300SpellerVisualization; }
