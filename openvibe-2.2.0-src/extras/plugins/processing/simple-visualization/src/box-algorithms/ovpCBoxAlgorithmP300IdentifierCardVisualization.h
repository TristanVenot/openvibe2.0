#ifndef __OpenViBEPlugins_BoxAlgorithm_P300IdentifierCardVisualization_H__
#define __OpenViBEPlugins_BoxAlgorithm_P300IdentifierCardVisualization_H__
...
namespace OpenViBEPlugins
{
	...
	{
		class CBoxAlgorithmP300IdentifierCardVisualization : public OpenViBEToolkit::TBoxAlgorithm < OpenViBE::Plugins::IBoxAlgorithm >
		{
		public:
			...
			_IsDerivedFromClass_Final_(OpenViBEToolkit::TBoxAlgorithm < OpenViBE::Plugins::IBoxAlgorithm >, OVP_ClassId_BoxAlgorithm_P300IdentifierCardVisualization);
		...
		private:
			...
			typedef void (CBoxAlgorithmP300IdentifierCardVisualization::*_cache_callback_)(CBoxAlgorithmP300IdentifierCardVisualization::SWidgetStyle& rWidgetStyle, void* pUserData);
			...
			void _cache_change_null_cb_(CBoxAlgorithmP300IdentifierCardVisualization::SWidgetStyle& rWidgetStyle, void* pUserData);
			void _cache_change_image_cb_(CBoxAlgorithmP300IdentifierCardVisualization::SWidgetStyle& rWidgetStyle, void* pUserData);
			void _cache_change_background_cb_(CBoxAlgorithmP300IdentifierCardVisualization::SWidgetStyle& rWidgetStyle, void* pUserData);
		...
		private:
			...
			std::vector <CBoxAlgorithmP300IdentifierCardVisualization::SWidgetStyle > m_vCache;

			OpenViBEVisualizationToolkit::IVisualizationContext* m_visualizationContext = nullptr;
		};

		class CBoxAlgorithmP300IdentifierCardVisualizationDesc : public OpenViBE::Plugins::IBoxAlgorithmDesc
		{
		public:

			virtual void release(void) { }

			virtual OpenViBE::CString getName(void) const                { return OpenViBE::CString("P300 Identifier Card Visualization"); }
			...
			virtual OpenViBE::CIdentifier getCreatedClass(void) const    { return OVP_ClassId_BoxAlgorithm_P300IdentifierCardVisualization; }
			virtual OpenViBE::Plugins::IPluginObject* create(void)       { return new OpenViBEPlugins::SimpleVisualization::CBoxAlgorithmP300IdentifierCardVisualization; }
				...
				OpenViBE::Kernel::IBoxProto& rBoxAlgorithmPrototype) const
			{
				...
				rBoxAlgorithmPrototype.addSetting("Interface filename",              OV_TypeId_Filename,    "${Path_Data}/plugins/simple-visualization/p300-identifier-card.ui");
				...
				rBoxAlgorithmPrototype.addSetting("Background Card filename",        OV_TypeId_Filename,    "${Path_Data}/plugins/simple-visualization/p300-magic-card/openvibe-logo.png");
			...
			_IsDerivedFromClass_Final_(OpenViBE::Plugins::IBoxAlgorithmDesc, OVP_ClassId_BoxAlgorithm_P300IdentifierCardVisualizationDesc);
		};
	};
};

#endif // __OpenViBEPlugins_BoxAlgorithm_P300IdentifierCardVisualization_H__
