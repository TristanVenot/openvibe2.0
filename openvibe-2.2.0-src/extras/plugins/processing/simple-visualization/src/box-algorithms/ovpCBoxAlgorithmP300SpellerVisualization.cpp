...
{
	((CBoxAlgorithmP300SpellerVisualization*)pUserData)->flushQueue();
	
	return false;	// Only run once
}

bool CBoxAlgorithmP300SpellerVisualization::initialize(void)
{
	const IBox& l_rStaticBoxContext=this->getStaticBoxContext();

	m_pMainWidgetInterface= nullptr;
	m_pToolbarWidgetInterface= nullptr;
	m_pFlashFontDescription= nullptr;
	m_pNoFlashFontDescription= nullptr;
	m_pTargetFontDescription= nullptr;
	m_pSelectedFontDescription= nullptr;
	...
	this->_cache_for_each_(&CBoxAlgorithmP300SpellerVisualization::_cache_change_background_cb_, &m_oNoFlashBackgroundColor);
	this->_cache_for_each_(&CBoxAlgorithmP300SpellerVisualization::_cache_change_foreground_cb_, &m_oNoFlashForegroundColor);
	this->_cache_for_each_(&CBoxAlgorithmP300SpellerVisualization::_cache_change_font_cb_, l_pMaxFontDescription);
...
bool CBoxAlgorithmP300SpellerVisualization::uninitialize(void)
{
	if(m_uiIdleFuncTag)
	{
		m_vStimuliQueue.clear();
	...
	if(m_pColumnSelectionStimulationDecoder)
	{
		...
		m_pColumnSelectionStimulationDecoder= nullptr;
	}
	...
	if(m_pRowSelectionStimulationDecoder)
	{
		...
		m_pRowSelectionStimulationDecoder= nullptr;
	}
...
bool CBoxAlgorithmP300SpellerVisualization::processInput(uint32 ui32Index)
{
	...
	if(!m_bTableInitialized)
	{
		this->_cache_for_each_(&CBoxAlgorithmP300SpellerVisualization::_cache_change_background_cb_, &m_oNoFlashBackgroundColor);
		this->_cache_for_each_(&CBoxAlgorithmP300SpellerVisualization::_cache_change_foreground_cb_, &m_oNoFlashForegroundColor);
		this->_cache_for_each_(&CBoxAlgorithmP300SpellerVisualization::_cache_change_font_cb_, m_pNoFlashFontDescription);
...
bool CBoxAlgorithmP300SpellerVisualization::process(void)
{
			...
			for(j=0; j<l_pStimulationSet->getStimulationCount(); j++)
			{
				...
				if(l_bFlash)
				{
					this->_cache_for_each_if_(
						l_iRow,
						l_iColumn,
						&CBoxAlgorithmP300SpellerVisualization::_cache_change_background_cb_,
						&CBoxAlgorithmP300SpellerVisualization::_cache_change_background_cb_,
					...
					this->_cache_for_each_if_(
						l_iRow,
						l_iColumn,
						&CBoxAlgorithmP300SpellerVisualization::_cache_change_foreground_cb_,
						&CBoxAlgorithmP300SpellerVisualization::_cache_change_foreground_cb_,
					...
					this->_cache_for_each_if_(
						l_iRow,
						l_iColumn,
						&CBoxAlgorithmP300SpellerVisualization::_cache_change_font_cb_,
						&CBoxAlgorithmP300SpellerVisualization::_cache_change_font_cb_,
				...
				for(j=0; j<l_pStimulationSet->getStimulationCount(); j++)
				{
					...
					if(l_bTarget && m_iTargetRow!=-1 && m_iTargetColumn!=-1)
					{
						...
						this->_cache_for_each_if_(
							...
							m_iTargetColumn,
							&CBoxAlgorithmP300SpellerVisualization::_cache_change_background_cb_,
							&CBoxAlgorithmP300SpellerVisualization::_cache_change_null_cb_,
						...
						this->_cache_for_each_if_(
							m_iTargetRow,
							m_iTargetColumn,
							&CBoxAlgorithmP300SpellerVisualization::_cache_collect_child_widget_cb_,
							&CBoxAlgorithmP300SpellerVisualization::_cache_collect_child_widget_cb_,
							&l_vWidgets,
							NULL);
...
void CBoxAlgorithmP300SpellerVisualization::_cache_build_from_table_(::GtkTable* pTable)
{
	if(pTable)
	{
		::GdkColor l_oWhite;
		...
		for(l_pList=pTable->children; l_pList; l_pList=l_pList->next)
		{
			...
			for(unsigned long i=l_pTableChild->top_attach; i<l_pTableChild->bottom_attach; i++)
			{
				...
				{
					CBoxAlgorithmP300SpellerVisualization::SWidgetStyle& l_rWidgetStyle=m_vCache[i][j];
					...
					l_rWidgetStyle.pFontDescription= nullptr;
				}
			}
		}
	}
...
void CBoxAlgorithmP300SpellerVisualization::_cache_for_each_(_cache_callback_ fpCallback, void* pUserData)
{
	std::map < unsigned long, std::map < unsigned long, CBoxAlgorithmP300SpellerVisualization::SWidgetStyle > >::iterator i;
	std::map < unsigned long, CBoxAlgorithmP300SpellerVisualization::SWidgetStyle >::iterator j;
...
void CBoxAlgorithmP300SpellerVisualization::_cache_for_each_if_(int iLine, int iColumn, _cache_callback_ fpIfCallback, _cache_callback_ fpElseCallback, void* pIfUserData, void* pElseUserData)
{
	std::map < unsigned long, std::map < unsigned long, CBoxAlgorithmP300SpellerVisualization::SWidgetStyle > >::iterator i;
	std::map < unsigned long, CBoxAlgorithmP300SpellerVisualization::SWidgetStyle >::iterator j;
...
void CBoxAlgorithmP300SpellerVisualization::_cache_change_null_cb_(CBoxAlgorithmP300SpellerVisualization::SWidgetStyle& rWidgetStyle, void* pUserData)
{
}

void CBoxAlgorithmP300SpellerVisualization::_cache_change_background_cb_(CBoxAlgorithmP300SpellerVisualization::SWidgetStyle& rWidgetStyle, void* pUserData)
{
...
void CBoxAlgorithmP300SpellerVisualization::_cache_change_foreground_cb_(CBoxAlgorithmP300SpellerVisualization::SWidgetStyle& rWidgetStyle, void* pUserData)
{
	::GdkColor oColor=*(::GdkColor*)pUserData;
...
void CBoxAlgorithmP300SpellerVisualization::_cache_change_font_cb_(CBoxAlgorithmP300SpellerVisualization::SWidgetStyle& rWidgetStyle, void* pUserData)
{
...
void CBoxAlgorithmP300SpellerVisualization::_cache_collect_widget_cb_(CBoxAlgorithmP300SpellerVisualization::SWidgetStyle& rWidgetStyle, void* pUserData)
{
	if(pUserData)
	{
...
void CBoxAlgorithmP300SpellerVisualization::_cache_collect_child_widget_cb_(CBoxAlgorithmP300SpellerVisualization::SWidgetStyle& rWidgetStyle, void* pUserData)
{
	if(pUserData)
	{
...
void CBoxAlgorithmP300SpellerVisualization::flushQueue(void)
{
