...
bool CBoxAlgorithmP300IdentifierCardVisualization::initialize(void)
{
	...
	// getVisualizationContext().setToolbar(m_pToolbarWidget);
	...
	this->_cache_for_each_(&CBoxAlgorithmP300IdentifierCardVisualization::_cache_change_background_cb_, &m_oBackgroundColor);
	return true;
}

boolean CBoxAlgorithmP300IdentifierCardVisualization::uninitialize(void)
{
...
boolean CBoxAlgorithmP300IdentifierCardVisualization::processInput(uint32 ui32Index)
{
...
boolean CBoxAlgorithmP300IdentifierCardVisualization::process(void)
{
...
void CBoxAlgorithmP300IdentifierCardVisualization::_cache_build_from_table_(::GtkTable* pTable)
{
	if(pTable)
	{
...
void CBoxAlgorithmP300IdentifierCardVisualization::_cache_for_each_(_cache_callback_ fpCallback, void* pUserData)
{
...
void CBoxAlgorithmP300IdentifierCardVisualization::_cache_for_each_if_(int iCard, _cache_callback_ fpIfCallback, _cache_callback_ fpElseCallback, void* pIfUserData, void* pElseUserData)
{
...
void CBoxAlgorithmP300IdentifierCardVisualization::_cache_change_null_cb_(CBoxAlgorithmP300IdentifierCardVisualization::SWidgetStyle& rWidgetStyle, void* pUserData)
{
}

void CBoxAlgorithmP300IdentifierCardVisualization::_cache_change_image_cb_(CBoxAlgorithmP300IdentifierCardVisualization::SWidgetStyle& rWidgetStyle, void* pUserData)
{
...
void CBoxAlgorithmP300IdentifierCardVisualization::_cache_change_background_cb_(CBoxAlgorithmP300IdentifierCardVisualization::SWidgetStyle& rWidgetStyle, void* pUserData)
{
