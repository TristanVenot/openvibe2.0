...
namespace OpenViBEPlugins
{
	namespace SimpleVisualization
	{
		...
		public:
			...
			virtual OpenViBE::CString getCategory(void) const            { return OpenViBE::CString("Simple visualization"); }
			...
			virtual OpenViBE::Plugins::IPluginObject* create(void)       { return new OpenViBEPlugins::SimpleVisualization::CAlgorithmLevelMeasure; }
