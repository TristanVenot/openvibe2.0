...
namespace OpenViBEAcquisitionServer
{
	...
	public:
		...
		CConfigurationNeuroskyMindset(OpenViBEAcquisitionServer::IDriverContext& rDriverContext, const char* sGtkBuilderFileName,OpenViBE::uint32& rComPort,OpenViBE::boolean& rESenseChannels,OpenViBE::boolean& rBandPowerChannels,OpenViBE::boolean& rBlinkStimulations,OpenViBE::boolean& rBlinkStrengthChannel);
	...
	protected:
		...
		OpenViBE::boolean& m_rBlinkStrengthChannel;
