...
static HANDLE g_pMutex= nullptr;
static HINSTANCE g_hNeXusDLLInstance= nullptr;
static NeXusDLL_Init g_fpNeXusDLLInit= nullptr;
static NeXusDLL_Start g_fpNeXusDLLStart= nullptr;
static NeXusDLL_Stop g_fpNeXusDLLStop= nullptr;

static OpenViBEAcquisitionServer::CDriverMindMediaNeXus32B* g_pDriver= nullptr;
	...
	IDriverCallback& rCallback)
{
	...
	if(!g_fpNeXusDLLInit || !g_fpNeXusDLLStart || !g_fpNeXusDLLStop || !m_pSample)
	{
		...
		delete [] m_pSample;
		g_hNeXusDLLInstance= nullptr;
		g_fpNeXusDLLInit= nullptr;
		g_fpNeXusDLLStart= nullptr;
		g_fpNeXusDLLStop= nullptr;
		m_pSample= nullptr;
		g_pMutex= nullptr;
		return false;
	}
