...
namespace OpenViBEAcquisitionServer
{
	...
	{
		public:
			CConfigurationDriverGenericOscillator(OpenViBEAcquisitionServer::IDriverContext& rDriverContext, 
				const char* sGtkBuilderFileName, OpenViBE::boolean& rSendPeriodicStimulations,
				OpenViBE::float64& rStimulationInterval);
		...
		OpenViBE::float64& m_rStimulationInterval;
