...
SceneNode* CGenericStimulatorFlickeringObject::m_poParentNode = nullptr;
CBasicPainter* CGenericStimulatorFlickeringObject::m_poPainter = nullptr;
...
CGenericStimulatorApplication* CGenericStimulatorFlickeringObject::m_poApplication = nullptr;
