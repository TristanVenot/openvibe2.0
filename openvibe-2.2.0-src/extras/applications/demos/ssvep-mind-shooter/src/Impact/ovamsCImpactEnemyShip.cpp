...
CImpactApplication* CImpactEnemyShip::m_poApplication = nullptr;
SceneNode* CImpactEnemyShip::m_poParentNode = nullptr;
CBasicPainter* CImpactEnemyShip::m_poPainter = nullptr;
