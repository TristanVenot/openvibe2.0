#ifndef __OpenViBEPlugins_BoxAlgorithm_Essai_H__
#define __OpenViBEPlugins_BoxAlgorithm_Essai_H__
...
#define OVP_ClassId_BoxAlgorithm_Essai (0x9043ece1, 0xc2dc5b71)
#define OVP_ClassId_BoxAlgorithm_EssaiDesc (0xad428a6b, 0xa842ddd6)
...
namespace OpenViBEPlugins
{
	...
	{
		/**
		* \class CBoxAlgorithmEssai
		* \author Tristan (Sorbonne Université)
		* \date Tue Feb 12 14:49:06 2019
		* \brief The class CBoxAlgorithmEssai describes the box Essai.
		*
		*/
		class CBoxAlgorithmEssai : virtual public OpenViBEToolkit::TBoxAlgorithm < OpenViBE::Plugins::IBoxAlgorithm >
		{
		public:

			CBoxAlgorithmEssai(void);
			...
			_IsDerivedFromClass_Final_(OpenViBEToolkit::TBoxAlgorithm < OpenViBE::Plugins::IBoxAlgorithm >, OVP_ClassId_BoxAlgorithm_Essai);

		protected:
			// Input decoder:
			OpenViBEToolkit::TStimulationDecoder < CBoxAlgorithmEssai > m_oInput0Decoder;
			OpenViBEToolkit::TStreamedMatrixDecoder < CBoxAlgorithmEssai > m_oInput1Decoder;
			// No Output decoder.
		...
		*/
		...
		class CBoxAlgorithmEssaiListener : public OpenViBEToolkit::TBoxListener < OpenViBE::Plugins::IBoxListener >
		{
		public:
		...
		*/
		...
		/**
		* \class CBoxAlgorithmEssaiDesc
		* \author Tristan (Sorbonne Université)
		* \date Tue Feb 12 14:49:06 2019
		* \brief Descriptor of the box Essai.
		*
		*/
		class CBoxAlgorithmEssaiDesc : virtual public OpenViBE::Plugins::IBoxAlgorithmDesc
		{
		public:

			virtual void release(void) { }

			virtual OpenViBE::CString getName(void) const                { return OpenViBE::CString("Essai"); }
			...
			virtual OpenViBE::CIdentifier getCreatedClass(void) const    { return OVP_ClassId_BoxAlgorithm_Essai; }
			virtual OpenViBE::Plugins::IPluginObject* create(void)       { return new OpenViBEPlugins::SignalProcessing::CBoxAlgorithmEssai; }

			/*
			virtual OpenViBE::Plugins::IBoxListener* createBoxListener(void) const               { return new CBoxAlgorithmEssaiListener; }
			...
			*/
			...
			_IsDerivedFromClass_Final_(OpenViBE::Plugins::IBoxAlgorithmDesc, OVP_ClassId_BoxAlgorithm_EssaiDesc);
		};
	};
};

#endif // __OpenViBEPlugins_BoxAlgorithm_Essai_H__
