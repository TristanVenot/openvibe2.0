...
[Tue Feb 12 14:24:50 2019]
-------------------------

The generator produced the following files:

The Box class:
- ovpCBoxAlgorithmVisualInterface.h
- ovpCBoxAlgorithmVisualInterface.cpp
...
You may have to change the file ovpCBoxAlgorithmVisualInterface.h to make it find the included file ovp_defines.h, whose path is related to the project used.
...
#include "[my-box-folder]/ovpCBoxAlgorithmVisualInterface.h"
