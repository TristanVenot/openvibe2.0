...
bool CPluginExternalStimulations::startHook(const std::vector<OpenViBE::CString>& /*vSelectedChannelNames*/, OpenViBE::uint32 /* ui32SamplingFrequency */, OpenViBE::uint32 /* ui32ChannelCount */, OpenViBE::uint32 /* ui32SampleCountPerSentBlock */)
{
