	...
	namespace OpenViBEAcquisitionServerPlugins
	{
		class CPluginExternalStimulations : public IAcquisitionServerPlugin
		{
			...
			public:
				...
				virtual bool startHook(const std::vector<OpenViBE::CString>&, OpenViBE::uint32 ui32SamplingFrequency, OpenViBE::uint32 ui32ChannelCount, OpenViBE::uint32 ui32SampleCountPerSentBlock);
