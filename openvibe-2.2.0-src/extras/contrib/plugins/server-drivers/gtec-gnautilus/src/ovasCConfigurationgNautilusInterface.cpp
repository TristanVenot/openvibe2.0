...
OpenViBE::boolean CConfigurationgNautilusInterface::getHardwareSettings(void)
{
	...
	size_t l_ui32SupportedNWChannelsCount;
	...
	size_t l_ui32SupportedSamplingRatesCount;
	...
	size_t l_ui32SupportedSensitivitiesCount;
	...
	size_t l_ui32SupportedInputSourcesCount;
...
{
	uint32_t l_ui32MountedModulesCount;
	size_t l_ui32ElectrodeNamesCount;
	char l_sTemporary[30];
...
boolean CConfigurationgNautilusInterface::getFiltersForNewSamplingRate(void)
{
	...
	size_t l_ui32BandPassFiltersCount, l_ui32NotchFiltersCount;
