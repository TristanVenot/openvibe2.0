	...
	IDriverCallback& rCallback)
{
	...
	size_t l_ui32ConnectedDevicesCount = 0;
...
boolean CDrivergNautilusInterface::start(void)
{
	...
	size_t l_ui32ScanCount = 0;
	size_t l_ui32ChannelsPerDevice = 0;
	size_t l_ui32BufferSizeInSamples = 0;
	...
	g_oDataReadyEventHandle = nullptr;
