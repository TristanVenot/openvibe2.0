...
static HINSTANCE g_hMitsarDLLInstance = nullptr;
static MitsarDLL_initialize g_fpMitsarDLLInitialize = nullptr;
static MitsarDLL_start g_fpMitsarDLLStart = nullptr;
static MitsarDLL_stop g_fpMitsarDLLStop = nullptr;
static MitsarDLL_uninitialize g_fpMitsarDLLUninitialize = nullptr;
static MitsarDLL_loop g_fpMitsarDLLLoop = nullptr;
	...
	IDriverCallback& rCallback)
{
	...
	if (!g_fpMitsarDLLInitialize || !g_fpMitsarDLLStart || !g_fpMitsarDLLStop || !g_fpMitsarDLLUninitialize || !g_fpMitsarDLLLoop)
	{
		...
		g_hMitsarDLLInstance      = nullptr;
		g_fpMitsarDLLInitialize   = nullptr;
		g_fpMitsarDLLStart        = nullptr;
		g_fpMitsarDLLStop         = nullptr;
		g_fpMitsarDLLUninitialize = nullptr;
		g_fpMitsarDLLLoop         = nullptr;
		return false;
	}
